...
const character = require(`./java.js`)
...
let redeJunge = `Der Junge fragt dich ob du Stress suchst und haut dir ins Gesicht. Willst du Kämpfen, Reden, Weitergehen, oder Zurückgehen? Wenn du reden willst musst du das reden mit Leerzeichen hinter dem Befehl eingeben Gib ein reden2, paul vs junge, feste(weiter) oder start(zurück)`;
...
let feste = `Du kommst zu einer Feste aus massivem Stein. Davor ist ein Soldat. Willst du Reden, weitergehen, oder Zurückgehen? Wenn du reden willst musst du das reden mit Leerzeichen hinter dem Befehl eingeben Gib ein reden, inFeste(weiter) oder brücke(zurück)`;
...
if(userInputArr[0] === `weg` && userInputArr[1] === undefined){
    console.log(weg);
}
...
if(userInputArr[0] === `wald2` && userInputArr[1] === `geben`){
    console.log(geben);
}
...
if(userInputArr[0] === `brücke` && userInputArr[1] === undefined){
    console.log(brücke);
}
...
if(userInputArr[0] === `feste` && userInputArr[1] === undefined){
    console.log(feste);
}
...
if(userInputArr[0] === `inFeste` && userInputArr[1] === undefined){
...
if(userInputArr[0] === `inFeste` && userInputArr[1] === `nein`){
    console.log(nein);
}


if(userInputArr[0] === `inFeste` && userInputArr[1] === `ja`){
    console.log(ja);
}

if(userInputArr[0] === `inFeste` && userInputArr[1] === `nichtgehen`){
    console.log(nichtgehen);
}

if(userInputArr[0] === `inFeste` && userInputArr[1] === `barkampf`){
    console.log(barkampf);
}

if(userInputArr[0] === `inFeste` && userInputArr[1] === `gehen`){
    console.log(gehen);
}

if(userInputArr[0] === `inFeste` && userInputArr[1] === `weglaufen`){
